...
const skills = {
    ...
    '마법사': {
        weak: { name: '파이어볼', manaCost: 10, damage: 4, cooldown: 5000, description: '전방의 적에게 4의 데미지를 줍니다.' },
        strong: { name: '라이트닝', manaCost: 20, damage: 8, cooldown: 10000, description: '원형 범위의 적들에게 8의 데미지를 줍니다.' },
        ultimate: { name: '메테오', manaCost: 100, damage: 20, cooldown: 0, description: '거대한 운석을 떨어뜨려 20의 데미지를 주고 땅을 불태웁니다.' }
    },
    '성직자': {
        ...
        ultimate: { name: '홀리라이트', manaCost: 75, damage: 15, cooldown: 0, description: '성스러운 빛으로 15의 피해를 주고 장판을 생성합니다.' }
    },
    '도적': {
        weak: { name: '단검던지기', manaCost: 7, damage: 3, cooldown: 5000, description: '적을 관통하는 단검을 던져 3의 데미지를 줍니다.' },
        strong: { name: '은신', manaCost: 15, duration: 5000, cooldown: 10000, description: '5초간 몬스터에게 어그로가 끌리지 않습니다.' },
        ultimate: { name: '암살', manaCost: 30, damage: 30, cooldown: 0, description: '단일 대상에게 30의 치명적인 데미지를 입힙니다.' }
    }
};
...
const shopItems = [
    ...
    { id: 'sword', name: '낡은 검', description: '검사 전용. 공격력 7.', price: 100, job: '검사', attack: 7 },
    { id: 'staff', name: '낡은 지팡이', description: '마법사 전용. 공격력 7.', price: 100, job: '마법사', attack: 7 },
    { id: 'cross', name: '낡은 십자가', description: '성직자 전용. 공격력 7.', price: 100, job: '성직자', attack: 7 },
    { id: 'dagger', name: '낡은 단검', description: '도적 전용. 공격력 7.', price: 100, job: '도적', attack: 7 }
];
