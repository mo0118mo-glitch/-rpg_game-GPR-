...
const shopItems = [
    ...
    { id: 'sword', name: '낡은 검', description: '검사 전용. 물리 공격력 7.', price: 100, job: '검사', attack: 7, damageType: 'physical', bonusMultiplier: 1.5 },
    { id: 'staff', name: '낡은 지팡이', description: '마법사 전용. 마법 공격력 7.', price: 100, job: '마법사', attack: 7, damageType: 'magic', bonusMultiplier: 1.2 },
    { id: 'cross', name: '낡은 십자가', description: '성직자 전용. 공격력 7.', price: 100, job: '성직자', attack: 7, damageType: 'hybrid', bonusMultiplier: 1.3 },
    { id: 'dagger', name: '낡은 단검', description: '도적 전용. 물리 공격력 7.', price: 100, job: '도적', attack: 7, damageType: 'physical', bonusMultiplier: 1.5 }
];
